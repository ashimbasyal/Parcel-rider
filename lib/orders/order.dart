...
import 'package:parcel_rider/approvedorder/details.dart';
import 'package:parcel_rider/cart/cart_model.dart';
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                return CartPage(jobList: JobList.listitm[index], key: null,);
              },
            ),
          )
        ],
